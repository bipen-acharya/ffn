                ...
                <div class="col">
                    ...
                    <div class="card mx-4 mb-4">
                        <div class="card-header">
                            <h6 class="card-title">{{$title}} | Edit</h6>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form class="form repeater" id="form" action="{{route($route.'update',$item->id)}}"
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-12 mt-3">
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <button id="add-new"
                                                    class="btn btn-primary @if($routeName == "Create") disabled @endif">
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <label style="margin-left: 70px">Movie Date <span
                                                class="text-danger">*</span></label>
                                    </div>
                                    <div class="col-md-3">
                                        <label style="margin-left: 70px">Movie Time <span
                                                class="text-danger">*</span></label>
                                    </div>
                                    <div class="col-md-3">
